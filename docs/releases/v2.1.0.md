...
1. 使用 `dist/burpsuite-mcp-bridge-2.1.0-all.jar` 替换已加载扩展。
...
- 拦截流程：`docs/intercept-workflow.md`、`docs/en/intercept-workflow.md`
- 兼容性：`docs/compatibility.md`、`docs/en/compatibility.md`
- 变更历史：`CHANGELOG.md`、`docs/en/changelog.md`
- 发布完整性：`dist/SHA256SUMS`、`dist/bom.cdx.json`
