...
1. Replace the loaded extension with `dist/burpsuite-mcp-bridge-2.1.0-all.jar`.
...
- Intercept procedure: `docs/en/intercept-workflow.md`
- Compatibility matrix: `docs/en/compatibility.md`
- Change history: `CHANGELOG.md`, `docs/en/changelog.md`
- Artifact integrity: `dist/SHA256SUMS`, `dist/bom.cdx.json`
